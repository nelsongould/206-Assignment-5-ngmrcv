...
phd_prop <- prop.table(as.matrix(phd_tble), 1)
...
phd_prop_tble <- kable(phd_prop_rnd, col.names = c("1985", "2000", "2015")) %>% 
  ...
  add_header_above(c(" " = 1, "Proportion of Female PhD Students by Field" = 3))
...
mf_paired_sal_graph <- ggplot(doc_salary, aes(x= field, y = salary/1000)) +
